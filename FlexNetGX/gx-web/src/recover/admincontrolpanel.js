...
async function displayData() {
    ...
    const container = document.getElementById('bountycreator-list-container');
...
async function handleFormSubmit(event) {
    try {
        ...
        if (await dataService.addRecord(formData)) {
            ...
            showMessage('bountycreator user created successfully!', 'success');
...
window.addEventListener('load', () => {
    ...
    try {
        // Verify Genesis bountycreator authentication
