...
const CONSTANTS = {
    ...
    SELECTORS: {
        ...
        INSTRUCTIONS: '#bountyhunter-instructions',
        HELP_BUTTON: '#help-button',
        HELP_FORM: '#help-request-form',
        bounties_AVAILABLE: '#bounties-available',
...
class App {
    ...
    initContent() {
        ...
        // Initialize bountyhunter instructions
    ...
    initEventListeners() {
        ...
        // bounty buttons - only show for appropriate roles
        if (this.elements.bounties_AVAILABLE && this.database.canAccessbounties()) {
            this.elements.bounties_AVAILABLE.addEventListener('click', () => {
                this.navigation.navigateTo('availablebounties.html');
            });
        }

        if (this.elements.bounties_COMPLETED && this.database.canAccessbounties()) {
            this.elements.bounties_COMPLETED.addEventListener('click', () => {
                this.navigation.navigateTo('completedbounties.html');
            });
        }
    }
