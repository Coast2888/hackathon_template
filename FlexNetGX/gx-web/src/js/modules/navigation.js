...
const navigation = {
    ...
    clearSessionCache: function() {
        // Store bountycreators list and setup status before clearing
        const bountycreators = localStorage.getItem('bountycreators');
        ...
        if (bountycreators) localStorage.setItem('bountycreators', bountycreators);
    ...
    initializeSidebar: function() {
        ...
        switch(userRole) {
            case 'genesis':
                templateId = 'genesisbountycreator-menu';
                break;
            case 'platformbountycreator':
                templateId = 'platformbountycreator-menu';
                break;
            case 'userbountycreator':
                templateId = 'userbountycreator-menu';
                break;
            default:
