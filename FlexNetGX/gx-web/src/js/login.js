...
class Auth {
    ...
    async handleLogin(event) {
        ...
        try {
            ...
            const bountycreator = data.find(user => user.name === username);
            console.log('Found bountycreator:', bountycreator);

            if (bountycreator && bountycreator.password === password) {
                console.log('bountycreator login successful:', bountycreator.type);
                sessionStorage.setItem('isAuthenticated', 'true');
