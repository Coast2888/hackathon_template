...
CREATE TABLE Roles (
    ...
    role_name VARCHAR(10) CHECK (role_name IN ('bountyhunter', 'moderate', 'bountycreator'))
);
...
CREATE TABLE bounties (
    ...
    bounty_name VARCHAR(20),
    bounty_description VARCHAR(45),
    target_type VARCHAR(10),
    target_id INT,
    due_date DATETIME
);

-- bounty_Questions Table
CREATE TABLE bounty_Questions (
    bounty_ques_id INT AUTO_INCREMENT PRIMARY KEY,
    bounty_id INT,
